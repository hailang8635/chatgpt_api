...
func Select_sqlx(fromuser string, keyword string, answer string, is_finished int, is_done int) []domain.KeywordAndAnswerItem {
	var keywordsArr []domain.KeywordAndAnswerItem
